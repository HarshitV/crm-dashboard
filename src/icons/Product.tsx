...
export const Product = ({ fill }: { fill: string }) => (
  <Icon
  ...
  >
    <svg>
      ...
      <path
        fill={fill || "#9197B3"}
        d="M12 13.08c-.13 0-.26-.03-.38-.1l-5.3-3.06a.742.742 0 0 1-.27-1.02c.21-.36.67-.48 1.02-.27l4.92 2.85 4.89-2.83c.36-.21.82-.08 1.02.27.2.35.08.82-.27 1.02l-5.26 3.04c-.11.06-.24.1-.37.1Z"
      />
      <path
        fill={fill || "#9197B3"}
